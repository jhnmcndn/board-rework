          ...
          >
            ...
            >
              <div className={styles.header}>
                ...
                <span data-click={sfx.popAudio} onClick={() => onClose?.()} className={styles.closeBtn} />
              </div>
              <div className={styles.addCardContainer}>
                <div className={styles.bodyContainer}>
                    ...
                    <ul>
                      ...
                      >
                        <TemplatedInputForUser
                          ...
                          label='真实姓名:'
                          placeholder={!special ? '请输入您的姓名' : '请输入与' + passedBankName + '实名认证的姓名'}
                        />
                      </li>
                      {!special && (
                        <li>
                      ...
                      >
                        <TemplatedInputForUser
                          ...
                          placeholder={!special ? '请输入开户行卡号' : '请输入' + passedBankName + '钱包地址'}
                        />
                      </li>
                      {!special && (
                        <li>
                  ...
                  >
                    <ButtonDesignTwo brad={0} buttonName='确认绑定' height={0.3} width={0.8} padding='0.035rem 0' />
                  </div>
                </div>
              </div>
            </motion.div>
